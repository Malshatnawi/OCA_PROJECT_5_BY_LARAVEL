												...
												<li>
													...
													<div class="we-comment">
														<div class="coment-head">
															...
															@method('Delete')
															@csrf
															<button class="we-reply" type="submit"><i class="fa fa-times-circle fa-1x" ></i></button>
	  														</form>
															@endif
														</div>
												...
												<li class="post-comment">
													...
													<div class="post-comt-box">
														...
														@csrf
															...
															<button type="submit" class="btn btn-primary bg-primary"><span>Comment</span></button>
														</form>	
													</div>
